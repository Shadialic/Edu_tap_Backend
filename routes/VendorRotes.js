...
vendorRouter.post('/vendor/signup', upload.single('image',1), vendorController.addTutor);
...
vendorRouter.post('/vendor/loadCourse',upload.single('image',1),CourseController.addCourse)
